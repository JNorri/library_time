    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 grid grid-cols-2 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="date_of_birth" name="date_of_birth" type="date" class="mt-1 block w-full" :value="old('date_of_birth', $user->date_of_birth ? \Carbon\Carbon::parse($user->date_of_birth)->format('Y-m-d') : '')" required autocomplete="date_of_birth" />
