...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('/department/{department}/employee/{employee}/assign',   [EmployeeDepartmentController::class, 'assignEmployeeToDepartment'])->name('departments.assignEmployeeToDepartment');
    Route::put('/department/{department}/employee/{employee}/unassign', [EmployeeDepartmentController::class, 'unassignEmployeeFromDepartment'])->name('departments.unassignEmployeeFromDepartment');
});
